...
def validate_range(value, value_range):
    ...
    if not isinstance(value, (int, float)):
        raise ValueError("Invalid value: must be an integer or float.")
...
class Measurement(models.Model):
    ...
    temperature = models.FloatField(validators=[validate_temp_range], null=True, blank=True)
    tds = models.FloatField(validators=[validate_tds_range], null=True, blank=True)  # Total Dissolved Solids
